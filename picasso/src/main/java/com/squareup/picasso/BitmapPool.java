 ...
 * This is different from a normal {@link Cache}. A normal cache allow reuse of the same bitmap with the same content.
 *
...
public interface BitmapPool {
     ...
     *
     * @param options
     * @return Bitmap that is not in use, and is compatible with the options. Returns null if such a bitmap does not exist
     */
    @Nullable

...
class BitmapHunter implements Runnable {
   ...
   * {@code inSampleSize}).
   */
  private static Bitmap decodeStream(InputStream stream, Request request, final BitmapPool bitmapPool) throws IOException {
  ...
  private static Bitmap transformResult(Request data, Bitmap result, int exifOrientation, @Nullable BitmapPool bitmapPool) {
